...
namespace chessD {
	...
	/// <summary>
	/// Summary for SaveWindow
	/// </summary>
	public ref class SaveWindow : public System::Windows::Forms::Form
	{
	public:
		SaveWindow(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(SaveWindow::typeid));
			...
			this->richTextBox2->Location = System::Drawing::Point(66, 139);
			this->richTextBox2->Name = L"richTextBox2";
			this->richTextBox2->Size = System::Drawing::Size(556, 470);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Yu Gothic UI", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label2->Location = System::Drawing::Point(61, 39);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Yu Gothic UI", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label1->Location = System::Drawing::Point(273, 90);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(108, 28);
			...
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Yu Gothic UI", 10.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->textBox1->Location = System::Drawing::Point(186, 37);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(436, 30);
			...
			this->button2->Location = System::Drawing::Point(363, 630);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(259, 57);
			this->button2->TabIndex = 105;
			this->button2->Text = L"Отмена";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &SaveWindow::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Rockwell", 10.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(66, 630);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(259, 57);
			this->button1->TabIndex = 104;
			this->button1->Text = L"Сохранить позицию";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &SaveWindow::button1_Click);
			// 
			// SaveWindow
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(710, 699);
